<?php
/*
Plugin Name: Quotation Tool
Description: Use the [quotation] shortcode to display the plugin
Version: 0.0.1
...
$gameroom = new advance2();
$gameroom->init();

function advance2_shortcode( $atts ) {
...
add_shortcode( 'quotation', 'advance2_shortcode' );
